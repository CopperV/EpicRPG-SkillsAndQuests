...
public class ManaStat extends StatItem {
	...
	public ManaStat(String id, String name,
	...
	public ItemStack getItem(Player p) {
		...
		if(rpg.getStats().getMana() + amount > limit)
	...
	public AEpicItem clone() {
		return new ManaStat(name, name, price, new LinkedList<>(requirements), limit, amount);
	}
