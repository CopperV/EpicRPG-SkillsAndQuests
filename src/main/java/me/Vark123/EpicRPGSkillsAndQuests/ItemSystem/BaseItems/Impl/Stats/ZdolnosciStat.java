...
public class ZdolnosciStat extends StatItem {
	...
	public ZdolnosciStat(String id, String name,
	...
	public boolean clickAction(Player p, ItemStack info, EpicNPC npc) {
		...
		rpg.getStats().addZdolnosci(amount);
		npc.openMenu(p);
		return true;
	}
	...
	public AEpicItem clone() {
		return new ZdolnosciStat(name, name, price, new LinkedList<>(requirements), limit, amount);
	}
