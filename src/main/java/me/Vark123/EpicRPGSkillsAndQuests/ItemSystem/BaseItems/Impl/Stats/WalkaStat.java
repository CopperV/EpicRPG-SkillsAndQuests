...
public class WalkaStat extends StatItem {
	...
	public WalkaStat(String id, String name,
	...
	public ItemStack getItem(Player p) {
		...
		if(rpg.getStats().getWalka() + amount > limit)
	...
	public AEpicItem clone() {
		return new WalkaStat(name, name, price, new LinkedList<>(requirements), limit, amount);
	}
