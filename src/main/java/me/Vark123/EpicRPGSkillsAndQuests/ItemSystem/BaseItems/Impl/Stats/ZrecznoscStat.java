...
public class ZrecznoscStat extends StatItem {
	...
	public ZrecznoscStat(String id, String name,
	...
	public ItemStack getItem(Player p) {
		...
		if(rpg.getStats().getZrecznosc() + amount > limit)
	...
	public boolean clickAction(Player p, ItemStack info, EpicNPC npc) {
		...
		rpg.getStats().addZrecznosc(amount);
		npc.openMenu(p);
		return true;
	}
	...
	public AEpicItem clone() {
		return new ZrecznoscStat(name, name, price, new LinkedList<>(requirements), limit, amount);
	}
