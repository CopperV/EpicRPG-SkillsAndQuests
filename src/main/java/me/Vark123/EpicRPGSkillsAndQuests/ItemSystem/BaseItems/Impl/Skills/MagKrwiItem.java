...
public class MagKrwiItem extends SkillItem {

	public MagKrwiItem(Collection<IRequirement> requirements) {
		super("skill_mag_krwi", "§2§lSkill: §e§oMag krwi", 10,
				requirements, Arrays.asList("§eWykorzystuj wlasne sily witalne","§edo tkania zaklec"));
	}
	...
	public AEpicItem clone() {
		return new MagKrwiItem(new LinkedList<>(requirements));
	}
