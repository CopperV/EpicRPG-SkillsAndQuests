...
public class ManaRegenerationItem extends SkillItem {

	public ManaRegenerationItem(Collection<IRequirement> requirements) {
		super("skill_manareg", "§2§lSkill: §e§oRegeneracja many", 15,
				requirements, Arrays.asList("§eWykorzystuj otaczajaca Ciebie przyrode,","§edo regeneracji wlasnej many"));
	}
	...
	public AEpicItem clone() {
		return new ManaRegenerationItem(new LinkedList<>(requirements));
	}
