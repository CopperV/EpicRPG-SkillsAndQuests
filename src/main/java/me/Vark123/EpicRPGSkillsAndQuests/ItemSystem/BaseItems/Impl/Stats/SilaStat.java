...
public class SilaStat extends StatItem {
	...
	public SilaStat(String id, String name,
	...
	public ItemStack getItem(Player p) {
		...
		if(rpg.getStats().getSila() + amount > limit)
	...
	public AEpicItem clone() {
		return new SilaStat(name, name, price, new LinkedList<>(requirements), limit, amount);
	}
