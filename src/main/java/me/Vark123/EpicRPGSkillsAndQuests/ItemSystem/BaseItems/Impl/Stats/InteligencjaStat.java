...
public class InteligencjaStat extends StatItem {
	...
	public InteligencjaStat(String id, String name,
	...
	public ItemStack getItem(Player p) {
		...
		if(rpg.getStats().getInteligencja() + amount > limit)
	...
	public boolean clickAction(Player p, ItemStack info, EpicNPC npc) {
		...
		rpg.getStats().addInteligencja(amount);
		npc.openMenu(p);
		return true;
	}
	...
	public AEpicItem clone() {
		return new InteligencjaStat(name, name, price, new LinkedList<>(requirements), limit, amount);
	}
